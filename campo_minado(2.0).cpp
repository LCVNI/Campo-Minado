...
int main() {
   ...
   printf("   ___   _   __  __ ___  ___       \n");
    printf("  / __| /_\\ |  \\/  | _ \\/ _ \\      \n");
    printf(" | (__ / _ \\| |\\/| |  _/ (_) |     \n");
    printf("  \\___/_/_\\_\\_| _|_|_|  \\___/ ___  \n");
    printf(" |  \\/  |_ _| \\| | /_\\ |   \\ / _ \\ \n");
    printf(" | |\\/| || || .` |/ _ \\| |) | (_) |\n");
   ...
   printf("   ___   _   __  __ ___  ___       \n");
    ...
    printf("  _   __________    ___  ____       ______  ________   ___  ____  ___    ___\n");
    printf(" | | / / __/_  /   / _ \\/ __ \\  __ / / __ \\/ ___/ _ | / _ \\/ __ \\/ _ \\  <  /\n");
    printf(" | |/ / _/  / /_  / // / /_/ / / // / /_/ / (_ / __ |/ // / /_/ / , _/  / / \n");
    printf(" |___/___/ /___/ /____/\\____/  \\___/\\____/\\___/_/ |_/____/\\____/_/|_|  /_/  \n");
    printf("                                                                            \n");
                ...
                if (minas2[escolhal1][escolhac1]) {
                    ...
                    system("cls");
     printf("  ___  ___   ___  __  __   _                                             \n");
    printf(" | _ )/ _ \\ / _ \\|  \\/  | | |                                            \n");
    printf(" | _ \\ (_) | (_) | |\\/| | |_|                                            \n");
    printf(" |___/\\___/ \\___/|_|  |_|_(_)___ ___  ___  _   _   __  __ ___ _  _   _   \n");
    printf("  | __| \\| |/ __/ _ \\| \\| |_   _| _ \\/ _ \\| | | | |  \\/  |_ _| \\| | /_\\  \n");
    printf("  | _|| .` | (_| (_) | .` | | | |   / (_) | |_| | | |\\/| || || .` |/ _ \\ \n");
    printf("  |___|_|\\_|\\___\\___/|_|\\_| |_| |_|_\\\\___/ \\___/  |_|  |_|___|_|\\_/_/ \\_\\\n");
    printf("                                                                          \n");
    printf("\nPERDEU A VEZ\n");
                    for (i = 0; i < 5; i++) {
                        for (j = 0; j < 5; j++) printf("%2c", campo2[i][j]);
                    ...
                    pontos1++;
                    system("cls");
    printf("    _   ___ ___ ___ _____ ___  _   _   _ \n");
    printf("   /_\\ / __| __| _ \\_   _/ _ \\| | | | | |\n");
    printf("  / _ \\ (__| _||   / | || (_) | |_| | |_|\n");
    printf(" /_/ \\_\\___|___|_|_\\ |_| \\___/ \\___/  (_)\n");
    printf("                                          \n");
    printf("\n+1 PONTO\n");
                    for (i = 0; i < 5; i++) {
                        for (j = 0; j < 5; j++) printf("%2c", campo2[i][j]);
    ...
    printf("  _   __________    ___  ____       ______  ________   ___  ____  ___    ___ \n");
    printf(" | | / / __/_  /   / _ \\/ __ \\  __ / / __ \\/ ___/ _ | / _ \\/ __ \\/ _ \\  |_  |\n");
    printf(" | |/ / _/  / /_  / // / /_/ / / // / /_/ / (_ / __ |/ // / /_/ / , _/ / __/ \n");
    printf(" |___/___/ /___/ /____/\\____/  \\___/\\____/\\___/_/ |_/____/\\____/_/|_| /____/ \n");
    printf("                                                                             \n");
                        printf("Campo do inimigo:\n");
                        for (i = 0; i < 5; i++) {
                ...
                if (minas1[escolhal2][escolhac2]) {
                    ...
                    system("cls");
                    printf("Jogador 2/Computador escolheu [%d][%d]\n", escolhal2 + 1, escolhac2 + 1);
     printf("  ___  ___   ___  __  __   _                                             \n");
    printf(" | _ )/ _ \\ / _ \\|  \\/  | | |                                            \n");
    printf(" | _ \\ (_) | (_) | |\\/| | |_|                                            \n");
    printf(" |___/\\___/ \\___/|_|  |_|_(_)___ ___  ___  _   _   __  __ ___ _  _   _   \n");
    ...
    printf("\n+1 PONTO!\n");
            ...
            printf("\nCampo final do Jogador 1 (minas do Jogador 2/Computador):\n");
			for (i = 0; i < 5; i++) {
			    for (j = 0; j < 5; j++) {
			        printf("%2c", campo2[i][j]);
			    }
			    printf("    |    ");
			    for (j = 0; j < 5; j++) {
			        printf("%2c", minas2[i][j] == 1 ? 'X' : '.');
			    }
			    printf("\n");
			}

			printf("\nCampo final do Jogador 2/Computador (minas do Jogador 1):\n");
			for (i = 0; i < 5; i++) {
			    for (j = 0; j < 5; j++) {
			        printf("%2c", campo1[i][j]);
			    }
			    printf("    |    ");
			    for (j = 0; j < 5; j++) {
			        printf("%2c", minas1[i][j] == 1 ? 'X' : '.');
			    }
			    printf("\n");
			}
	...
	printf("\nCampo final do Computador 1 (minas do Computador 2):\n");
	for (i = 0; i < 5; i++) {
	    for (j = 0; j < 5; j++) {
	        printf("%2c", campo2[i][j]);
	    }
	    ...
	    for (j = 0; j < 5; j++) {
	        printf("%2c", minas2[i][j] == 1 ? 'X' : '.'); // Exibe minas
	    }
	    printf("\n");
	}

	printf("\nCampo final do Computador 2 (minas do Computador 1):\n");
	for (i = 0; i < 5; i++) {
	    for (j = 0; j < 5; j++) {
	        printf("%2c", campo1[i][j]);
	    }
